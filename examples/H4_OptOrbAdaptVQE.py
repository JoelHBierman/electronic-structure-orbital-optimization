...
adapt_vqe_instance = AdaptVQE(solver=vqe_instance)
adapt_vqe_instance.supports_aux_operators = lambda: True

optorbvqe_instance = OptOrbAdaptVQE(problem=q_molecule,
                               integral_tensors = None,
                               num_spin_orbitals=num_reduced_qubits,
                               ground_state_solver=adapt_vqe_instance,
                               mapper=mapper,
                               estimator=estimator,
