...
class OptOrbMCVQE(OptOrbEigensolver):
    ...
    def __init__(self,
        ...
        if excited_states_solver.__class__.__name__ != 'MCVQE':

            raise AlgorithmError(f"The ground state solver needs to be of type MCVQE, not {excited_states_solver.__class__.__name__}")
        ...
        rotated_one_body_integrals = torch.einsum('pq,pi,qj->ij',
                                                  ...
                                                  init_partial_unitary, init_partial_unitary).detach().numpy()
        rotated_two_body_integrals = torch.einsum('pqrs,pi,qj,rk,sl->ijkl',
                                                  self.two_body_integrals,
                                                  init_partial_unitary, init_partial_unitary, init_partial_unitary,
                                                  init_partial_unitary).detach().numpy()

        for solver in self._excited_states_solver_list:
...
class OptOrbMCVQEResult(OptOrbEigensolverResult):
